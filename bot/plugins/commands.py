    ...
    return await msg.reply(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(text='• ᴜᴩᴅᴀᴛᴇꜱ •', url='https://telegram.me/moviesandwebserieshubOrzz'),
                    InlineKeyboardButton(text='• ꜱᴜᴩᴩᴏʀᴛ •', url='https://t.me/+gRJCrS6hpqZlYTg1')
                ],
                [
...
async def send_emojis(_, msg: Message):
    return await msg.reply(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(text='👨‍💻 ᴏᴡɴᴇʀ', url='https://telegram.me/XD_Loki'),
                    InlineKeyboardButton(text='💥 ʀᴇᴘᴏ', url='https://github.com/Aimielab/ARB')
                ]
            ]
        )
    )
